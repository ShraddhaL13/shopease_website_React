...
import { getCartData } from '../Redux/CarRedux/action';
        ...
        <Box bg={"#eef6f9"} p="2rem" >
            <Flex justifyContent="space-around" alignItems="center" bg="white">
                ...
                <Box lineHeight="3rem" bg="white"  >
                    ...
                    <Flex gap={5} >
                        <button style={{ color: "#ff7856",   width: "200px",    height: "50px",  backgroundColor: "white",
                            borderRadius: "10px",  border: "2px solid #ff7856"
                         }} onClick={handleAddCard} >ADD TO CART</button>
                        
                        <button style={{color: "white", width: "200px", height: "50px", backgroundColor: "#ff7856",
                            borderRadius: "10px"}}>BUY NOW</button>
                    </Flex>
