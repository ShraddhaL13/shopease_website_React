...
import { Box, Container, Link, SimpleGrid, Stack, Text, Flex, useColorModeValue, Image } from '@chakra-ui/react';
            ...
            <Box bg={useColorModeValue('gray.50', 'gray.900')} color={useColorModeValue('gray.700', 'gray.200')}>
                ...
                <Box py={10}>
                    <Flex align={'center'} _before={{
                        content: '""', borderBottom: '1px solid', borderColor: useColorModeValue('gray.200', 'gray.700'),
                        flexGrow: 1, mr: 8,
                    }}
                        _after={{
                            content: '""',
