...
const SearchComp = () => {
    ...
    return (
        <VStack max-width="28rem">
            <HStack spacing="0">
                <Input value={inputval} onChange={handleChange} placeholder=" What is on your mind today?"
                 size='md' w="40rem" bg="#e9f6f7" />
                <Button onClick={() => navigate("/mobile")} bg='rgb(255,120,86)' px="2rem" color="white" 
