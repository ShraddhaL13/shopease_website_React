import { Box, Text, Image, Button, Checkbox, Input, Select, } from "@chakra-ui/react";
    ...
    return (
        <>
            <Box height={"auto"} bg={"#F3F7FB"}>
                ...
                <Box height={"auto"} bg={"#F3F7FB"}>
                    <Box display={"flex"} gap={8} mt={5} width={"76%"}
                        ml={125} height={"auto"} >

                        <Box bg={"#F3F7FB"} p={0} rounded={"lg"} height={"auto"}
                            width={"100%"}>
                            ...
                            <Box p={4} bg={"white"} mt={5} rounded={"lg"} height={"auto"}
                                width={"100%"}>
                                ...
                                <Box display={"flex"} pr={3} justifyContent={"space-between"}>
                                    <Box display={"flex"} pt={3} gap={8}>
                                        <Image height={30} src="https://www.netmeds.com/assets/pgicon/Paytm_lo.png"
                                            alt="paytm" />
                            ...
                            <Box p={4} bg={"white"} mt={5} rounded={"lg"} height={"auto"}
                                ...
                                <Box display={"flex"} pr={3} justifyContent={"space-between"}>
                                    <Box display={"flex"} pt={3} gap={8}>
                                        <Image height={30} src="https://www.netmeds.com/msassets/images/icons/TWID.png"
                                            alt="paytm" />
                            ...
                            <Box p={4} bg={"white"} mt={5} rounded={"lg"} height={"auto"}
                                ...
                                <Box display={"flex"} pr={3} justifyContent={"space-between"}>
                                    <Box display={"flex"} pt={3} gap={8}>
                                        <Image height={30} src="https://www.netmeds.com/assets/pgicon/Free_Charge_lo.png"
                                            alt="paytm" />
                            ...
                            <Box p={4} bg={"white"} mt={5} rounded={"lg"} height={"auto"}
                                ...
                                <Box display={"flex"} pt={3} gap={8} justifyContent={"space-between"}>
                                    <Image height={30} src="https://www.netmeds.com/msassets/images/icons/simpl-logo.png"
                                        alt="paytm" />
                            ...
                            <Box p={4} bg={"white"} mt={5} rounded={"lg"} height={"auto"}
                                ...
                                <Box display={"flex"} pr={3} justifyContent={"space-between"}>
                                    <Box display={"flex"} pt={3} gap={8}>
                                        <Image height={30} src="https://www.netmeds.com/assets/pgicon/Phone_Pay_lo.png"
                                            alt="paytm" />
